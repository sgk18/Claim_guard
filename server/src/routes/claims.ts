...
export async function claimRoutes(fastify: FastifyInstance, options: { controller: ClaimController }) {
  ...
  fastify.get("/claims", (req: any, reply) => controller.getAll(req, reply));
  fastify.get("/claims/:id", (req: any, reply) => controller.getById(req, reply));
  fastify.post("/claims", (req: any, reply) => controller.submit(req, reply));
  fastify.post("/claims/:id/confirm", (req: any, reply) => controller.confirm(req, reply));
  ...
  fastify.get("/employees/me/claims", (req: any, reply) => controller.getAll(req, reply));
}
