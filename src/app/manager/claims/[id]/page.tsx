        ...
        <div className="flex items-center gap-2">
          {claim.status !== "APPROVED" && (
            <button
              ...
              className="px-4 py-2 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl text-xs font-bold flex items-center gap-1.5 shadow-lg shadow-emerald-600/20 transition-colors"
            >
          ...
          {claim.status !== "REJECTED" && (
            <button
              ...
              className="px-4 py-2 bg-rose-600 hover:bg-rose-500 text-white rounded-xl text-xs font-bold flex items-center gap-1.5 shadow-lg shadow-rose-600/20 transition-colors"
            >
              <X className="w-4 h-4" />
              Reject Claim
            </button>
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-4 sm:p-6 lg:p-8 grid lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-6 space-y-6">
          ...
          <div className="bg-slate-900 rounded-3xl p-5 border border-slate-800 shadow-lg">
            <div className="flex items-center gap-2 pb-3 mb-3 border-b border-slate-800 text-xs font-bold text-slate-400 uppercase tracking-wider">
            ...
            <div className="grid grid-cols-2 gap-4 text-xs">
              ...
              <div>
                <span className="text-slate-500">Associated Business Trip</span>
          ...
          <div className="bg-slate-900 rounded-3xl p-5 border border-slate-800 shadow-lg">
            ...
            {claim.managerNotes && (
              <div className="mt-4 pt-3 border-t border-slate-800 bg-slate-850/60 p-3 rounded-xl">
